...
class Complex:
    ...
    def get_extracted_rb_info(
        ...
        def rep_bond_energy_fn(body):
            ...
            rep_val += base_bond_rep(jnp.array([4, 0]), spider_space_frame_pos, vertex_to_bind_center)
            return rep_val
...
def combined_body_to_injavis_lines(
    ...
    _, shell_box_def, shell_type_defs, shell_pos = complex_.shell.body_to_injavis_lines(
        vertex_body, box_size, shell_patch_radius)
...
class TestComplex(unittest.TestCase):
    ...
    def test_sim_extracted(self):
        ...
        # leg_spring_eps = 100000.
        leg_spring_eps = float(jnp.exp(5.0))
        displacement_fn, shift_fn = space.free()
        ...
        combined_body, base_energy_fn = complex_.get_extracted_rb_info() # FIXME: use actual values
