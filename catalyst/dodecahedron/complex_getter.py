...
from catalyst.dodecahedron.spider_getter import SpiderInfo
...
class ComplexInfo:
    ...
    def load(self):
        ...
        ## Step 2, get vector to which we want to map that vector -- i.e. the one pointing from the vertex to bind to the center of the shell
        ...
        ## Step 3, find the quaternion that maps orig_vec onto reorienteed_vec
        ...
        self.shape_species = onp.array(list(onp.zeros(20)) + [1], dtype=onp.int32).flatten()
    ...
    def get_leg_energy_fn(self, soft_eps, bond_diameter, leg_alpha):
        ...
        def leg_energy_fn(body):
            ...
            shell_vertex_centers = shell_body_pos[::4]
    ...
    def get_energy_components_fn(
            ...
            morse_ii_eps=30.0, morse_ii_alpha=3.0,
    ...
    def body_to_injavis_lines(
            self, body, box_size,
            shell_patch_radius=0.25, shell_vertex_color="43a5be", shell_patch_color="4fb06d",
...
class TestComplexInfo(unittest.TestCase):
    ...
    complex_info = ComplexInfo(
            ...
            spider_base_radius=1.5, spider_head_height=4.0,
    ...
    def test_write_injavis(self):
        ...
        with open('dodecahedron_complex.pos', 'w+') as of:
            of.write('\n'.join(injavis_lines))
