...
for op in tqdm([1, 2], desc="OP"):
    ...
    eq_states_path = fig3_data_basedir / f"wham-op{op}" / "flexible-all" / "wham_eq_states.pos"
    ...
    if op == 1:
        state_idxs = [15, 25, 35, 55, 75, 150, 260, 270, 280, 290, 300, 310, 320, 340, 475] # keep
        distances = list(onp.linspace(3.2, 5.0, 250)) + list(onp.linspace(5.0, 15.0, 250))
    elif op == 2:
        state_idxs = [30, 50, 100, 130, 170, 190, 210, 225, 260, 275, 280, 350, 445, 450, 460, 492, 493, 495]
