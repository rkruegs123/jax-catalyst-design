...
from catalyst.icosahedron import complex_getter, shell_getter
...
output_basedir = Path("figures/revisions/output/fig1/d")
...
for mode in ["initial-fat-spider", "final-good-spider", "just-entire-shell"]:
    ...
    if mode == "initial-fat-spider":
        ...
        def render_pos(x, y, z):
            ...
            # image.show()
            image.save(str(output_basedir / "just_spider_fat.png"))
        render_pos(150, 100, 50)
        ...
        def render_pos(x, y, z):
            ...
            # image.show()
            image.save(str(output_basedir / "just_spider_good.png"))
        render_pos(150, 100, 50)
        ...
        def check_pos(x=100, y=100, z=100):
            ...
            image.save(str(output_basedir / "just_shell_1d.png"))
            # image.show()
