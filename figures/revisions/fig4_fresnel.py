...
spider_head_height = 7.0
spider_base_particle_radius = 1.0
spider_attr_particle_pos_norm = 0.3
...
geometry_shell.color[::(num_patches+1)] = fresnel.color.linear(grey_vertex_color)

geometry_shell.color[vertex_to_bind_idx*(num_patches+1)] = fresnel.color.linear(shell_vertex_color)
