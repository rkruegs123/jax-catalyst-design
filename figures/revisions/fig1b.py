...
output_basedir = Path("figures/revisions/output/fig1/b")
...
# (mode, one_missing, one_vertex, init_sep_coeff, fname)
configurations = [
    ("complex-bound", False, False, 1.0, "complex-bound.png"),
    ("just-spider", False, False, 1.0, "just-spider.png"),
    ("just-entire-shell", False, True, 1.0, "single-vertex.png"),
    ("just-entire-shell", True, False, 1.0, "one-missing.png"),
    ("complex-unbound", False, False, 1.0, "extracted-bound.png"),
    ("complex-unbound", False, False, 4.0, "extracted-unbound.png")
]

for mode, one_missing, one_vertex, init_sep_coeff, fname in configurations:
