...
ax.plot(test_distances, init_morse_fn(test_distances), label=f"Initial", linewidth=3, color="blue")
ax.plot(test_distances, opt_morse_fn(test_distances), label=f"Optimized", linewidth=3, color="green")
...
plt.tight_layout()
# plt.show()
plt.savefig(output_basedir / "diffusive_potentials.pdf")
plt.close()


fig, ax = plt.subplots(figsize=(16, 10))
test_distances = onp.linspace(min_dist-0.25, 6.0, 250)
ax.plot(test_distances, init_morse_fn(test_distances), label=f"Initial", linewidth=3, color="blue")
...
plt.tight_layout()
# plt.show()
plt.savefig(output_basedir / "diffusive_potentials_inset.pdf")
plt.close()
